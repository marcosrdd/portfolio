...
Contact.create(portfolio: Portfolio.last, email: 'marcosrdd@gmail.com', phone: '999', website: 'http://clinicastabarbara.com.br', address_country: 'Brasil')
Block.create(portfolio: Portfolio.last, kind: :contact, side: :left, position: 3)
 
Social.create(kind: :facebook, url: 'https://www.facebook.com/clinicastabarbara', portfolio: Portfolio.last)
Block.create(portfolio: Portfolio.last, kind: :social, side: :left, position: 4)
 
Experience.create(title: 'StaBarbara', description: 'great clinic', start_date: Time.now - 2.years, company: 'StaBarbara', portfolio: Portfolio.last)
Block.create(portfolio: Portfolio.last, kind: :experience, side: :right, position: 1)
 
Education.create(title: 'StaBarbara', description: 'great clinic', start_date: Time.now - 2.years, institution: 'StaBarbara', portfolio: Portfolio.last)
